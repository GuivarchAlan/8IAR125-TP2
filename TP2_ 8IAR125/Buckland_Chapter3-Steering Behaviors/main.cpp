                    ...
                    int       iCmdShow)
{
  ...
  hWnd = CreateWindowEx (NULL,                 // extended style
                         ...
                         GetSystemMetrics(SM_CXSCREEN)/2 - GetSystemMetrics(SM_CXSCREEN) / 2.2,
                         GetSystemMetrics(SM_CYSCREEN)/2 - GetSystemMetrics(SM_CYSCREEN) / 2.2,
      GetSystemMetrics(SM_CXSCREEN) / 1.1,     // initial x size
      GetSystemMetrics(SM_CYSCREEN) / 1.1,    // initial y size
